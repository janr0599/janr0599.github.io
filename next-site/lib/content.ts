...
export const projects: Project[] = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "agent", label: "AI Agent", detail: "Bilingual, with memory per conversation, and tools it can call mid-sentence.", x: 760, y: 145, kind: "ai" },
      { id: "kb", label: "Knowledge base", detail: "Answers come from a vector store of the company's own documents rather than from the model alone.", x: 680, y: 290, kind: "ai" },
      { id: "tools", label: "Look up and book", detail: "Finds the contact, creates the lead, checks availability, then books, moves or cancels the appointment.", x: 840, y: 290, kind: "system" },
      { id: "guardout", label: "Output guardrails", detail: "The reply is checked before it is sent. A trip hands the conversation to a person instead of delivering it.", x: 1000, y: 145, kind: "logic" },
      { id: "reply", label: "Reply", detail: "Split into short messages and sent back one at a time with a typing delay.", x: 1320, y: 30, kind: "trigger" },
      { id: "needed", label: "Human needed?", detail: "A classifier reads the turn and answers yes or no to one question: did they ask for a person?", x: 1160, y: 145, kind: "ai" },
      { id: "human", label: "Hand to a person", detail: "The assistant switches off for that conversation and the team is emailed. It stays off until someone turns it back on.", x: 1320, y: 260, kind: "human" },
    ],
    edges: [
